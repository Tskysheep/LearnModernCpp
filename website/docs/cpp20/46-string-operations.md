...
C++20 标准引入的 字符串操作 (starts_with / ends_with) 特性完整教学示例。

## 完整源码

```cpp title="cpp20/46_string_operations.cpp"
/**
 * ============================================================
...
- [cppreference: 字符串操作 (starts_with / ends_with)](https://en.cppreference.com/w/cpp/string/basic_string/starts_with)
