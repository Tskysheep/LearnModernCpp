...
# 模板 Lambda (Template Lambdas)

C++20 标准引入的 模板 Lambda (Template Lambdas) 特性完整教学示例。

## 完整源码

```cpp title="cpp20/09_template_lambdas.cpp"
/**
 * ============================================================
...
- [cppreference: 模板 Lambda (Template Lambdas)](https://en.cppreference.com/w/cpp/language/lambda)
