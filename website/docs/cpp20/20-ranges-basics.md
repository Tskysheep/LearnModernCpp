...
# Ranges 基础 (std::ranges 算法)

C++20 标准引入的 Ranges 基础 (std::ranges 算法) 特性完整教学示例。

## 完整源码

```cpp title="cpp20/20_ranges_basics.cpp"
/**
 * ============================================================
...
- [cppreference: Ranges 基础 (std::ranges 算法)](https://en.cppreference.com/w/cpp/ranges)
