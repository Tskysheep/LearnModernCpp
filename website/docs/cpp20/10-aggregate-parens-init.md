...
# 圆括号聚合初始化 (Parenthesized Aggregate Initialization)

C++20 标准引入的 圆括号聚合初始化 (Parenthesized Aggregate Initialization) 特性完整教学示例。

## 完整源码

```cpp title="cpp20/10_aggregate_parens_init.cpp"
/**
 * ============================================================
...
- [cppreference: 圆括号聚合初始化 (Parenthesized Aggregate Initialization)](https://en.cppreference.com/w/cpp/language/direct_initialization)
