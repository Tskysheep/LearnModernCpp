...
# integer_sequence与index_sequence

C++14 标准引入的 integer_sequence与index_sequence 特性完整教学示例。

## 完整源码

```cpp title="cpp14/09_integer_sequence.cpp"
/**
 * ============================================================
...
- [cppreference: integer_sequence与index_sequence](https://en.cppreference.com/w/cpp/utility/integer_sequence)
