...
C++11 标准引入的 noexcept 说明符与运算符 特性完整教学示例。

## 完整源码

```cpp title="cpp11/13_noexcept.cpp"
/**
 * ============================================================
...
- [cppreference: noexcept 说明符与运算符](https://en.cppreference.com/w/cpp/language/noexcept_spec)
