...
C++11 标准引入的 智能指针 (unique_ptr、shared_ptr、weak_ptr) 特性完整教学示例。

## 完整源码

```cpp title="cpp11/40_smart_pointers.cpp"
/**
 * ============================================================
...
- [cppreference: 智能指针 (unique_ptr、shared_ptr、weak_ptr)](https://en.cppreference.com/w/cpp/memory/unique_ptr)
