...
C++11 标准引入的 std::forward_list (单向链表) 特性完整教学示例。

## 完整源码

```cpp title="cpp11/45_forward_list.cpp"
/**
 * ============================================================
...
- [cppreference: std::forward_list (单向链表)](https://en.cppreference.com/w/cpp/container/forward_list)
