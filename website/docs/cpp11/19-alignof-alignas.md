...
C++11 标准引入的 alignof 与 alignas 特性完整教学示例。

## 完整源码

```cpp title="cpp11/19_alignof_alignas.cpp"
/**
 * ============================================================
...
- [cppreference: alignof 与 alignas](https://en.cppreference.com/w/cpp/language/alignof)
