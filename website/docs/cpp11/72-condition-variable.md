...
C++11 标准引入的 条件变量 (condition_variable) 特性完整教学示例。

## 完整源码

```cpp title="cpp11/72_condition_variable.cpp"
/**
 * ============================================================
...
- [cppreference: 条件变量 (condition_variable)](https://en.cppreference.com/w/cpp/thread/condition_variable)
