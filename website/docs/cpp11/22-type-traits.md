...
C++11 标准引入的 类型特征 (Type Traits) 特性完整教学示例。

## 完整源码

```cpp title="cpp11/22_type_traits.cpp"
/**
 * ============================================================
...
- [cppreference: 类型特征 (Type Traits)](https://en.cppreference.com/w/cpp/header/type_traits)
