...
C++11 标准引入的 用户自定义字面量 (User-Defined Literals) 特性完整教学示例。

## 完整源码

```cpp title="cpp11/17_user_defined_literals.cpp"
/**
 * ============================================================
...
- [cppreference: 用户自定义字面量 (User-Defined Literals)](https://en.cppreference.com/w/cpp/language/user_literal)
