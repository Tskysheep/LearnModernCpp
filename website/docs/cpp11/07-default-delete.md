...
C++11 标准引入的 =default 与 =delete 特性完整教学示例。

## 完整源码

```cpp title="cpp11/07_default_delete.cpp"
/**
 * ============================================================
...
- [cppreference: =default 与 =delete](https://en.cppreference.com/w/cpp/language/function#Deleted_functions)
