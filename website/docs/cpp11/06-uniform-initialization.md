...
# 统一初始化 (Uniform Initialization / Brace Initialization)

C++11 标准引入的 统一初始化 (Uniform Initialization / Brace Initialization) 特性完整教学示例。

## 完整源码

```cpp title="cpp11/06_uniform_initialization.cpp"
/**
 * ============================================================
...
- [cppreference: 统一初始化 (Uniform Initialization / Brace Initialization)](https://en.cppreference.com/w/cpp/language/list_initialization)
