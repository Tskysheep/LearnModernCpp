...
C++11 标准引入的 std::function 与 std::bind 特性完整教学示例。

## 完整源码

```cpp title="cpp11/44_function_and_bind.cpp"
/**
 * ============================================================
...
- [cppreference: std::function 与 std::bind](https://en.cppreference.com/w/cpp)
