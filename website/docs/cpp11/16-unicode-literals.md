...
C++11 标准引入的 Unicode字面量与字符类型 特性完整教学示例。

## 完整源码

```cpp title="cpp11/16_unicode_literals.cpp"
/**
 * ============================================================
...
- [cppreference: Unicode字面量与字符类型](https://en.cppreference.com/w/cpp/language/string_literal)
