...
C++11 标准引入的 可变参数模板 (Variadic Templates) 特性完整教学示例。

## 完整源码

```cpp title="cpp11/20_variadic_templates.cpp"
/**
 * ============================================================
...
- [cppreference: 可变参数模板 (Variadic Templates)](https://en.cppreference.com/w/cpp/language/parameter_pack)
