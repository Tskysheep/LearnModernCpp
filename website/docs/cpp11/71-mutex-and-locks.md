...
# 互斥锁与锁 (mutex、lock_guard、unique_lock)

C++11 标准引入的 互斥锁与锁 (mutex、lock_guard、unique_lock) 特性完整教学示例。

## 完整源码

```cpp title="cpp11/71_mutex_and_locks.cpp"
/**
 * ============================================================
...
- [cppreference: 互斥锁与锁 (mutex、lock_guard、unique_lock)](https://en.cppreference.com/w/cpp/thread/mutex)
