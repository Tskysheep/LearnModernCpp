...
C++23 标准引入的 size_t 字面量后缀 (uz/UZ) 特性完整教学示例。

## 完整源码

```cpp title="cpp23/03_size_t_literal.cpp"
/**
 * ============================================================
...
- [cppreference: size_t 字面量后缀 (uz/UZ)](https://en.cppreference.com/w/cpp/language/integer_literal)
