...
# std::move_only_function（仅移动函数包装器）

C++23 标准引入的 std::move_only_function（仅移动函数包装器） 特性完整教学示例。

## 完整源码

```cpp title="cpp23/42_move_only_function.cpp"
/**
 * ============================================================
...
- [cppreference: std::move_only_function（仅移动函数包装器）](https://en.cppreference.com/w/cpp/utility/functional/move_only_function)
