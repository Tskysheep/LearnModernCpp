...
C++17 标准引入的 std::clamp、std::gcd、std::lcm (数学工具) 特性完整教学示例。

## 完整源码

```cpp title="cpp17/56_clamp_gcd_lcm.cpp"
/**
 * ============================================================
...
- [cppreference: std::clamp、std::gcd、std::lcm (数学工具)](https://en.cppreference.com/w/cpp/algorithm/clamp)
