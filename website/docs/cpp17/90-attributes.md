...
C++17 标准引入的 C++17 属性 [[nodiscard]]、[[maybe_unused]]、[[fallthrough]] 特性完整教学示例。

## 完整源码

```cpp title="cpp17/90_attributes.cpp"
/**
 * ============================================================
...
- [cppreference: C++17 属性 [[nodiscard]]、[[maybe_unused]]、[[fallthrough]]](https://en.cppreference.com/w/cpp/language/attributes)
