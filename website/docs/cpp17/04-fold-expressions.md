...
C++17 标准引入的 折叠表达式 (Fold Expressions) 特性完整教学示例。

## 完整源码

```cpp title="cpp17/04_fold_expressions.cpp"
/**
 * ============================================================
...
- [cppreference: 折叠表达式 (Fold Expressions)](https://en.cppreference.com/w/cpp/language/fold)
