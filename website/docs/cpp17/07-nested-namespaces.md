...
C++17 标准引入的 嵌套命名空间 (Nested Namespaces) 特性完整教学示例。

## 完整源码

```cpp title="cpp17/07_nested_namespaces.cpp"
/**
 * ============================================================
...
- [cppreference: 嵌套命名空间 (Nested Namespaces)](https://en.cppreference.com/w/cpp/language/namespace)
